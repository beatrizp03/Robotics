...
namespace rrt_planner {
    ...
    class RRTPlanner {
        ...
        public:
             ...
             * @return  True if found, false otherwise 
             */
            void smoothPath(std::vector<geometry_msgs::PoseStamped>& plan);
            
            /**
             * @brief   Optimizes the path with straight lines
             * @return  True if found, false otherwise 
             */
            void optimizePath(std::vector<geometry_msgs::PoseStamped>& plan);
